...
async function main() {
    ...
    console.log(data);
    const cancel = await program.methods.cancel().accounts({
    ...
    cancel.feePayer = initializerWallet.publicKey
    cancel.recentBlockhash = blockhash.blockhash
    const signed = await initializerWallet.signTransaction(cancel)
